        ...
        >
          <div className="space-y-4">
            <h2 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
              Ready to <span className="text-transparent bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text">Transform</span> Your Future?
            </h2>
            <p className="text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Join the revolution in education and unlock your potential with AI-powered learning that adapts to your unique journey
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center items-center mt-20 text-gray-400">
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <span className="text-sm">Start instantly, no strings attached</span>
            </div>
            <div className="flex flex-col items-center gap-2 text-center">
              <div className="w-12 h-12 bg-green-500/20 rounded-full flex items-center justify-center mb-2">
                <svg className="w-6 h-6 text-green-400" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="font-semibold text-white">21-Day Premium Trial</span>
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <span className="text-sm">No commitments or hidden fees</span>
            </div>
          </div>
          
          <div className="mt-16 pt-8 border-t border-gray-800">
            <p className="text-gray-500 text-sm">
              Join 250,000+ learners already transforming their careers with Olympus AI
            </p>
          </div>
        </motion.div>
      </div>
